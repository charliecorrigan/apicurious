...
describe GithubService do
  ...
  context ".fetch_followed_recent_activity" do
    it "returns an array of hashes" do
      VCR.use_cassette("github_service.fetch_followed_recent_activity") do
        github_service = GithubService.new({token: ENV["github_user_token"], login: "charliecorrigan"})
        recent_events = github_service.fetch_followed_recent_activity
        recent_event = recent_events.first
